...
class WxPayApi
{
	...
	public static function unifiedOrder($inputObj, $timeOut = 6)
	{
		...
		$inputObj->SetAppid(BS_APPID);//公众账号ID WxPayConfig::APPID
		$inputObj->SetMch_id(BS_MCHID);//商户号 WxPayConfig::MCHID
	...
	public static function bizpayurl($inputObj, $timeOut = 6)
	{
		...
		$inputObj->SetAppid(BS_APPID);//公众账号IDWxPayConfig::APPID
		$inputObj->SetMch_id(BS_MCHID);//商户号WxPayConfig::MCHID
